...
class VulnerabilityAnalysisAgent:
    ...
    async def analyze(self, evidence: list[dict[str, Any]], context: dict[str, Any] | None = None) -> list[dict[str, Any]]:
        findings = []
    ...
    def _check_known_vulnerabilities(self, service: str, version: str) -> dict[str, Any] | None:
        checks = {
            ...
            "apache httpd": {"vulnerable_versions": ["< 2.4.54"], "severity": "high", "cwe": "CWE-416"},
